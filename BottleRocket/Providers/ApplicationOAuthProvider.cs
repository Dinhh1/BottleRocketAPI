...
namespace BottleRocket.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            // NOTE:: this method allows up to modify the Token end point and add properties to it
        ...
        public static AuthenticationProperties CreateProperties(string userName, string userId)
        {
            ...
            {
                { "userName", userName },
                {"userId", userId} // added custom userId property
            };
