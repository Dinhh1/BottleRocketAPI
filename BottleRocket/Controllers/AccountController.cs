...
using BottleRocket.Results;
using BottleRocket.BusinessLogic;

namespace BottleRocket.Controllers
{

    //NOTE:: Most of the codes on this page was generated by the project template
    // and the only method we're using right now is Register
